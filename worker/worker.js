...
■ 2枚引き(two-card)の場合:
{
  "current": "現在の状況の解釈（2〜3文）",
  "countermeasure": "対策・アドバイスカードの解釈（2〜3文）",
  "relationship": "2枚のカードの関係性から読み取れること（2文）",
...
■ ヘキサグラム(hexagram)の場合（六芒星7枚配置: △過去・現在・近未来 + ▽対策・お相手・本人 + 中央:最終結果）:
{
  "past": "過去の解釈（2文）",
  "present": "現在の解釈（2文）",
  "near_future": "近未来の解釈（2文）",
  "countermeasure": "アドバイス・対策（2〜3文、具体的な行動指針）",
  "environment": "お相手の気持ち・周囲の環境（2文、関係者や周囲の状況がどう影響しているか）",
  "inner_feelings": "本人の気持ち（2文、相談者の深層心理や本音）",
  "final_result": "最終結果（2〜3文、7枚すべてを踏まえた結論）",
  "overall": "総合鑑定（6〜8文、7枚の関係性を深く読み解いた詳細な洞察）",
  "advice": "具体的なアクションアドバイス（2文）",
  "lucky_item": "ラッキーアイテム"
}

■ ホースシュー(horseshoe)の場合（7枚U字馬蹄形配置: 過去→現在→未来→アドバイス→周囲→障害→最終結果）:
{
  "past": "過去の解釈（2文）",
  "present": "現在の解釈（2文）",
  "future": "未来の解釈（2文）",
  "advice_card": "アドバイスカードの解釈（2〜3文、具体的な行動指針）",
  "others_influence": "周囲の影響（2文、周りの人や環境がどう作用しているか）",
  "obstacles": "障害・課題（2文、乗り越えるべき壁）",
  "outcome": "最終結果（2〜3文、7枚すべてを踏まえた結論）",
  "overall": "総合鑑定（6〜8文、7枚の流れを時系列で深く読み解いた詳細な洞察）",
  "advice": "具体的なアクションアドバイス（2文）",
  "lucky_item": "ラッキーアイテム"
}

■ リレーションシップクロス(rel-cross)の場合（5枚恋愛十字: あなた→お相手→過去・基盤→現在の関係→未来の方向）:
{
  "you": "あなた（2〜3文、あなた自身の立場・エネルギー・課題）",
  "partner": "お相手（2〜3文、相手の立場・エネルギー・課題）",
  "past": "過去・基盤（2文、二人の関係の土台・これまでの経緯）",
  "present": "現在の関係（2〜3文、今の二人の間に流れているエネルギー）",
  "future": "未来の方向（2〜3文、二人の関係が向かう先）",
  "overall": "総合鑑定（6〜8文、十字の全体像から二人の関係を読み解いた詳細な洞察）",
  "advice": "具体的なアクションアドバイス（2文）",
  "lucky_item": "ラッキーアイテム"
}

■ ミラースプレッド(rel-mirror)の場合（7枚恋愛鏡像: テーマ→あなたの思考→あなたの感情→あなたの行動→相手の思考→相手の感情→相手の行動）:
{
  "theme": "関係のテーマ（2〜3文、二人の関係全体を貫くテーマ）",
  "your_thoughts": "あなたの思考（2文、あなたが頭で考えていること・意識的な認識）",
  "your_feelings": "あなたの感情（2文、あなたの心が感じていること・無意識の想い）",
  "your_actions": "あなたの行動（2文、あなたが実際にとっている態度・振る舞い）",
  "partner_thoughts": "お相手の思考（2文、相手が頭で考えていること・意識的な認識）",
  "partner_feelings": "お相手の感情（2文、相手の心が感じていること・無意識の想い）",
  "partner_actions": "お相手の行動（2文、相手が実際にとっている態度・振る舞い）",
  "overall": "総合鑑定（6〜8文、左右の鏡像を対比し、二人のズレや共鳴を読み解いた詳細な洞察）",
  "advice": "具体的なアクションアドバイス（2文）",
  "lucky_item": "ラッキーアイテム"
}

■ Yes/Noスプレッド(yesno)の場合（3枚: 賛成の力→反対の力→結論）:
{
  "verdict": "Yes/No/Maybe（1単語）",
  "verdict_reason": "判定理由（2〜3文、なぜその判定になったか）",
  "pro": "賛成の力（Yesに導くカードの解釈）（2文）",
  "con": "反対の力（Noに導くカードの解釈）（2文）",
  "conclusion": "結論カードの解釈（2文、最終的な天秤の傾き）",
  "overall": "総合メッセージ（3〜4文）",
  "advice": "アドバイス（1文）"
}
...
必ず指定されたJSON形式のみで返答してください（他のテキストは不要）。`,
        buildPrompt: (params) => {
            ...
            const positionNames = {
                'two-card': ['現在の状況', '対策・アドバイス'],
                'three-card': ['過去', '現在', '未来'],
                'five-card': ['現在の状況', '障害・課題', '過去の影響', '未来の可能性', '最終結論'],
                'two-choice': ['現在', 'A 近未来', 'B 近未来', 'A 最終結果', 'B 最終結果', 'アドバイス'],
                'hexagram': ['過去', '現在', '近未来', 'アドバイス・対策', 'お相手の気持ち・周囲の環境', '本人の気持ち', '最終結果'],
                'horseshoe': ['過去', '現在', '未来', 'アドバイス', '周囲の影響', '障害・課題', '最終結果'],
                'rel-cross': ['あなた', 'お相手', '過去・基盤', '現在の関係', '未来の方向'],
                'rel-mirror': ['関係のテーマ', 'あなたの思考', 'あなたの感情', 'あなたの行動', 'お相手の思考', 'お相手の感情', 'お相手の行動'],
                'yesno': ['賛成の力', '反対の力', '結論']
            };
            ...
            const modeMap = {
                ...
                'two-card': '2枚引き（ツーカード：現状・対策）',
                'three-card': '3枚引き（過去・現在・未来）',
                'five-card': '5枚引き（ケルト十字簡易版：現状・障害・過去・未来・結論）',
                'two-choice': '2者択一（6枚V字配置：現在・A近未来・B近未来・A最終結果・B最終結果・アドバイス）',
                'hexagram': 'ヘキサグラム（7枚・六芒星：過去・現在・未来・対策・環境・本心・最終結果）',
                'horseshoe': 'ホースシュー（7枚・馬蹄形：過去・現在・未来・アドバイス・周囲・障害・最終結果）',
                'rel-cross': 'リレーションシップクロス（5枚・恋愛十字：あなた・お相手・過去・現在・未来）',
                'rel-mirror': 'ミラースプレッド（7枚・恋愛鏡像：テーマ・あなたの思考/感情/行動・相手の思考/感情/行動）',
                'yesno': 'Yes/Noスプレッド（3枚：賛成の力・反対の力・結論）'
            };
