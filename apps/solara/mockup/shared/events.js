...
(function() {
  ...
  function injectOverlayStyles() {
    ...
    style.textContent = [
      ...
      '  font-family:Lato,"Noto Sans JP",sans-serif; line-height:1.4;',
      '}',
      '.moon-overlay-sub {',
      ...
      '  font-family:"Noto Sans JP",Lato,sans-serif; line-height:1.5;',
      '}',
      ...
      '  color:#EAEAEA; font-size:13px; font-family:"Noto Sans JP",Lato,sans-serif;',
      ...
      '  font-family:"Noto Sans JP",Lato,sans-serif; transition:all 0.2s ease;',
      '}',
      ...
      '  font-size:14px; font-weight:700; font-family:"Noto Sans JP",Lato,sans-serif;',
    ...
    var html = '<div class="moon-overlay-screen" id="overlayCrystal">' +
      '<div class="moon-overlay-inner">' +
        ...
        '<div style="font-size:13px;color:#EAEAEA;line-height:1.8;max-width:310px;text-align:center;' +
          'font-weight:300;font-family:Lato,sans-serif;padding:8px 0;">' +
          warmMsg +
        '</div>' +
