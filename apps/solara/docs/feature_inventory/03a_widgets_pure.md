...
### `lib/widgets/class_card.dart` (335 行)
...
- relative: `../i18n/strings.g.dart`, `../screens/paywall_screen.dart`, `../theme/solara_colors.dart`, `../utils/device_security_status.dart`
...
### `lib/widgets/solara_nav_bar.dart` (259 行)
...
- L44 `totalHeight()` — systemNav 込みの NavBar 全体の高さ。
- L56 `systemNavInset()`
- L78 `build()`
