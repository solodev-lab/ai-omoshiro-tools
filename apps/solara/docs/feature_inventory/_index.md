...
| 層 | 名称 | ファイル数 | Markdown |
| --- | --- | --- | --- |
| 0 | Worker (バックエンド計算式) | 28 | [00_worker.md](00_worker.md) |
| 1a | 純計算ユーティリティ | 10 | [01a_pure_calc.md](01a_pure_calc.md) |
...
| 2b | 永続化/キャッシュ | 10 | [02b_persistence.md](02b_persistence.md) |
...
| 4a | Map 画面 | 27 | [04a_map.md](04a_map.md) |
...
| 4e | Sanctuary 画面 | 11 | [04e_sanctuary.md](04e_sanctuary.md) |
...
- Worker JS ファイル: 28
- Worker エンドポイント総数: 34
- Dart class/mixin/extension/enum 総数: 489
- Dart 関数総数 (素拾い): 1669
