...
| 層 | 名称 | ファイル数 | Markdown |
| --- | --- | --- | --- |
| 0 | Worker (バックエンド計算式) | 25 | [00_worker.md](00_worker.md) |
...
| 4f | サブ画面 (Forecast / Locations / Philosophy / Font Preview) | 28 | [04f_subscreens.md](04f_subscreens.md) |
...
- Worker JS ファイル: 25
- Worker エンドポイント総数: 31
- Dart class/mixin/extension/enum 総数: 438
- Dart 関数総数 (素拾い): 1462
