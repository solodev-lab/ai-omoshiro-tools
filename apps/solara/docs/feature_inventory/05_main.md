...
**imports:** dart=0 / package=3 / relative=30
...
- L97 `class SolaraApp : StatefulWidget`
- L108 `class _SolaraAppState : State`
- L177 `class SolaraHome : StatefulWidget`
- L184 `class _SolaraHomeState : State`
...
- L197 `initState()`
- L375 `dispose()`
- L414 `didChangeAppLifecycleState()`
- L527 `build()`

  <details><summary>private 関数 8 件</summary>

  - L215 `_restoreLastScreen()`
  - L283 `_restorePushedRoute()`
  - L338 `_saveRestoreSnapshot()`
  - L385 `_onSigninCelebration()`
  - L403 `_onMapFocusRequested()`
  - L447 `_onGalaxyOverlayChanged()`
  - L473 `_refreshMoonStatus()`
  - L491 `_onTabTap()`
