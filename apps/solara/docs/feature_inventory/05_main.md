...
- L86 `class SolaraApp : StatefulWidget`
- L97 `class _SolaraAppState : State`
- L146 `class SolaraHome : StatefulWidget`
- L153 `class _SolaraHomeState : State`
...
- L403 `build()`
  ...
  - L177 `_restoreLastScreen()`
  - L237 `_restorePushedRoute()`
  - L290 `_saveRestoreSnapshot()`
  - L328 `_onMapFocusRequested()`
  - L365 `_onGalaxyOverlayChanged()`
  - L380 `_onTabTap()`
