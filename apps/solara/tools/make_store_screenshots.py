...
SCREENS = [
    ...
    {"slug": "horoscope",
     ...
     "sub":   ["天体・アスペクト・ハウスを本格計算。", "Tスクエア等レア配置の成立日も算出。"],
     "stats": {"head": "本格占星術を、フル計算。",
               "items": [["10", "惑星"], ["12", "ハウス"],
                         ["8", "アスペクト種"], ["3", "層を重ねる"]]}},
    {"slug": "cycle",
     "lines": ["恋も、豊かさも。", "めぐる季節を、先に。"],
     "sub":   ["1年の星のサイクルと節目の日を、", "ランキングで見渡す。"],
     "stats": {"head": "星のサイクルを、ひと目で。",
               "items": [["5", "星のサイクル"], ["Top5", "節目の日"],
                         ["365", "日を精査"], ["10", "惑星から算出"]]}},
    {"slug": "heatmap",
     "lines": ["1年の星のリズムを、", "色で見渡す。"],
     "sub":   ["365日をカテゴリ別の色で表示。", "Proなら5年先まで見通せる。"],
     "stats": {"head": "1年を、色で見渡す。",
               "items": [["365", "日を可視化"], ["5", "年先(Pro)"],
                         ["5", "目的別カテゴリ"], ["10", "惑星から算出"]]}},
    {"slug": "star_reading",
     "lines": ["星が語る、", "今日のあなたへの指針。"],
     "sub":   ["全体・恋愛・豊かさ・仕事・対話の5つの視点で、", "今日の星をカテゴリ別に読み解く（Proは全5種）。"]},
    {"slug": "tarot",
